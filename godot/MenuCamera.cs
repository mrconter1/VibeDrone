...
// the tree is paused (ProcessMode=Always), and only moves while Active (auto-orbit; not user
// controllable). DroneController makes it current for the full-screen menus and hands back to the
// drone camera when play starts.
