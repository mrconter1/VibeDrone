...
namespace OpenDrone
{
    // Engine-agnostic grey-box drone flight model, fitted from flight logs.
    // Pure C# + System.Numerics, no engine types -> drop into anything.
    // Coordinates: Y up, body +Z forward, +X right.
    public sealed class FlightModel
    {
        // --- fitted parameters (grey-box; split vertical drag: linear accel R2 0.94,
        //     drift 4.2% @0.5s) ---
        ...
        // re-deriving from this model's left-handed quaternion.
        ...
        // Captures motor spread for rotation + saturation.
        ...
        {
            // angular rate lags the commanded target (first-order)
